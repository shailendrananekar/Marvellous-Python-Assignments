...
# def MarvellousDiabeticLogisticRegression(datapath):
...
# file = open("diabetic_LogisticRegression_model.pkl", "wb")
# pickle.dump(model, file)
# file.close()
# print("Model exported successfully!")
# print(Line)
# saved_model = pickle.load(open("diabetic_LogisticRegression_model.pkl", "rb"))
...
# df.to_csv("diabetic_predict_LogisticReg.csv", index=False)
# print("Predictions exported successfully!")


def main():
    # MarvellousDiabeticLogisticRegression("diabetes.csv")
