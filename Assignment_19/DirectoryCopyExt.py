...
def DirCopy(DirectoryName, copyDirectory, fileExtension):
...
def main():
    ...
    if len(sys.argv) == 2:
        if sys.argv[1] == "--h" or sys.argv[1] == "--H":
            ...
            print("ScriptName.py NameofDirectory copyDirectory fileExtension")

    elif len(sys.argv) == 4:
        DirCopy(sys.argv[1], sys.argv[2],sys.argv[3])
